...
@Component({
  selector: 'app-menu-items-recipe-remove',
  templateUrl: './menu-items-recipe-remove.component.html',
  styleUrls: ['./menu-items-recipe-remove.component.scss']
})
export class MenuItemsRecipeRemoveComponent implements OnInit {
