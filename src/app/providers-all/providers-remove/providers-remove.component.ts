...
@Component({
  selector: 'app-provider-remove',
  templateUrl: './providers-remove.component.html',
  styleUrls: ['./providers-remove.component.scss']
})
export class ProvidersRemoveComponent implements OnInit {
